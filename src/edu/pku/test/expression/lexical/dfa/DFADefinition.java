package edu.pku.test.expression.lexical.dfa;

import static edu.pku.test.expression.lexical.LexicalConstants.*;
...
public class DFADefinition {
	...
	private void initStringStates(){
		...
		STRING_3.setNextMidState(ESCAPE_PATTERN, STRING_1);
